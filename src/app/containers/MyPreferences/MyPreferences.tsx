...
import { Dimensions, Image, Text, TouchableOpacity, View, StatusBar, ScrollView, Platform } from "react-native";
...
export class MyPreferences extends Component<NavigationScreenProps, ComponentState> {
        ...
        return (
            <Container style={styles.container}>
                ...
                <View style={{ flexDirection: 'row', width: width, padding: 20, justifyContent: 'space-between', alignItems: 'center' }}>
                    <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'black' }}>MY PREFERENCES</Text>
